...
> 1 апреля OpenAI объявила, что ChatGPT 3.5 можно использовать без входа в систему, см. [Начните использовать ChatGPT мгновенно](https://openai.com/blog/start-using-chatgpt-instantly).

🚀 Список бесплатных зеркальных сайтов ChatGPT(<https://chat.openai.com/>) и других бесплатных ресурсов, постоянно обновляется.

Веб-сайты, перечисленные здесь, взяты из Интернета, пожалуйста, не вводите на этих веб-сайтах какую-либо личную конфиденциальную информацию.

🌈 Приветствуется вклад

- [Добавить сайт]()
- [Сообщить о недоступном сайте]()
- Дополнительно (в разработке)

Если вы найдете этот проект полезным, не забудьте поставить звездочку 🌟. Ваша поддержка — это моя мотивация двигаться вперед.
...
* [Потрясающий бесплатный ChatGPT](#-Потрясающий-бесплатный-ChatGPT)
  ...
  * [Больше...](#bolshe)
    * [Хотите создать собственное зеркало ChatGPT](#-Хотите-создать-собственное-зеркало-ChatGPT)
    * [Подсказки](#-Подсказки)
    * [Общайтесь со своим контентом](#-Общайтесь-со-своим-контентом)
    * [Инструменты для разработчиков](#instrumenty-dlya-razrabotchikov)
...
> Значение тегов
> 
> - 🆓 Полностью бесплатно, готово к использованию после открытия 
> - 🔓 Имеет бесплатную квоту 
> - 🔑 Требуется ключ API 
> - 💪 Поддерживает GPT4 
> - 🧰 Не только чат, поддерживает другие модели или функции
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>2023-10-11</td>
            <td><details>
<summary>Контент слишком длинный, нажмите, чтобы развернуть.</summary>
Введите пароль доступа freegpt3 в настройках.
</details></td>
        </tr>
        <tr>
            <td>29</td>
        ...
        <tr>
            ...
            <td><details>
<summary>Контент слишком длинный, нажмите, чтобы развернуть.</summary>
Введите пароль доступа chatcat в настройках.
</details></td>
        </tr>
        <tr>
            <td>65</td>
        ...
        <tr>
            ...
            <td><details>
<summary>Контент слишком длинный, нажмите, чтобы развернуть.</summary>
Введите пароль доступа 586-482-535B в настройках.
</details></td>
        </tr>
        <tr>
            <td>77</td>
        ...
        <tr>
            ...
            <td><details>
<summary>Контент слишком длинный, нажмите, чтобы развернуть.</summary>
Введите пароль доступа 857857 в настройках.
</details></td>
        </tr>
        <tr>
            <td>80</td>
...
Введите пароль доступа 857857 в настройках.
        ...
        <tr>
            ...
            <td>2023-05-26</td>
            <td><details>
<summary>Содержание слишком длинное, нажмите, чтобы развернуть.</summary>
Шаги бесплатной операции: Перейдите в настройки API и выберите «Использовать пользовательскую конечную точку API». Затем введите https://free.churchless.tech/v1/chat/completions в качестве конечной точки и оставьте поле API-ключа пустым.
</details></td>
        </tr>
        <tr>
            <td>103</td>
...
## 🗨️ <a id="alternativy-chatgpt">Альтернативы ChatGPT</a>

- 👍 [Poe - быстрый и полезный ИИ-чат](https://poe.com) - Poe позволяет вам задавать вопросы, получать мгновенные ответы и вести диалог с ИИ. Предоставляет доступ к GPT-4, gpt-3.5-turbo, Claude от Anthropic и множеству других ботов.
- [Bing Chat](https://www.bing.com/chat)
- [Google Bard](https://bard.google.com)
- [HuggingChat](https://huggingface.co/chat) - Первая альтернатива ChatGPT с открытым исходным кодом. 💪
- [Anthropic Claude](https://www.anthropic.com/product) - ИИ-помощник нового поколения для любых задач, независимо от их масштаба.
- [Anthropic Claude 2](https://claude.ai/) - Подробнее см. на <https://www.anthropic.com/index/claude-2>
- [Чат с большими языковыми моделями](https://chat.lmsys.org/) от <https://github.com/lm-sys/FastChat> - Открытая платформа для обучения, обслуживания и оценки больших языковых моделей. Репозиторий для Vicuna и FastChat-T5.
- [Open Assistant](https://open-assistant.io/) - Разговорный ИИ для всех. Проект с открытым исходным кодом для создания чат-бота GPT LLM, управляемого LAION и участниками со всего мира.
- [Pi, ваш личный ИИ](https://heypi.com/talk) - Привет, я Pi. Я ваш личный ИИ, созданный, чтобы быть полезным, умным и доступным в любое время. Обращайтесь ко мне за советом, ответами или просто поговорите со мной о чем угодно.
- [TruthGPT Chat](https://talk.truthgpt.one/) - Привет, я TruthGPT! Маяк правды в мире неизвестного. Мы можем либо просто поговорить, либо вы можете задать мне сложные вопросы!
- [ERNIE Bot](https://yiyan.baidu.com)
- [Tongyi Qianwen](https://tongyi.aliyun.com/) - Единый бренд для больших моделей Alibaba, охватывающий такие области, как язык, слух и мультимодальность; стремится к достижению универсального интеллекта, близкого к человеческому, позволяя ИИ перейти от "одночувствительного" к "полностью открытому восприятию".
- [iFLYTEK Spark](https://xinghuo.xfyun.cn/) - iFLYTEK StarFire Cognitive Large Model - это большая языковая модель, выпущенная iFLYTEK, которая может интеллектуально отвечать на вопросы, понимая естественный язык.
- [Tiangong](https://tiangong.kunlun.com/) - Tiangong - первая в Китае двуязычная языковая модель на миллиард параметров, конкурирующая с ChatGPT, а также диалоговый ИИ-помощник.
- [Doubao](https://www.doubao.com/) - Doubao - ваш интеллектуальный помощник, который может отвечать на вопросы, давать идеи, помогать в творчестве и общаться с вами на любую интересующую вас тему.
- [OpenAgents](https://github.com/xlang-ai/OpenAgents) - Репликация ChatGPT Plus с открытым исходным кодом, включая Code Interpreter, плагины и веб-браузер.
- [ChatGLM](https://www.chatglm.cn/) - Новое поколение предварительно обученных диалоговых моделей, совместно выпущенных Zhipu AI и Tsinghua KEG.

## 📚 <a id="bolshe">Больше...</a>


### 💿 Хотите создать собственное зеркало ChatGPT?

- https://github.com/Yidadaa/ChatGPT-Next-Web - Развертывание хорошо продуманного веб-интерфейса ChatGPT на Vercel в один клик. 
- https://github.com/mckaywrigley/chatbot-ui - Пользовательский интерфейс ChatGPT с открытым исходным кодом.
- https://github.com/Chanzhaoyu/chatgpt-web - Демонстрационный веб-сайт ChatGPT, созданный с помощью Express и Vue3.
- https://github.com/anse-app/chatgpt-demo - Минималистичный веб-интерфейс для ChatGPT.
- https://github.com/869413421/chatgpt-web - Частное веб-приложение, реализованное на основе API ChatGPT3.5.
- https://github.com/ztjhz/BetterChatGPT - Потрясающий пользовательский интерфейс для ChatGPT от OpenAI (веб-сайт + Windows + MacOS + Linux)
- https://github.com/ourongxing/chatgpt-vercel - Элегантный и мощный. Работает на OpenAI и Vercel.

### 💡 Подсказки


- [Рекомендации по работе с GPT - OpenAI API](https://platform.openai.com/docs/guides/gpt-best-practices)
- [Prompt Engineering для разработчиков ChatGPT - DeepLearning.AI](https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/)
- https://github.com/f/awesome-chatgpt-prompts - Репозиторий включает в себя подборку подсказок ChatGPT для более эффективного использования ChatGPT.


### 📝 Общайтесь со своим контентом

- [ChatDOC - общайтесь со своими документами](https://chatdoc.com/) - ChatDOC - это помощник для чтения файлов на основе ChatGPT, который может быстро извлекать, находить и обобщать информацию из документов, понимать тексты, таблицы и изображения.
- [Humata - GPT для ваших файлов](https://www.humata.ai/) - Humata - это как GPT для ваших файлов. Спрашивайте ИИ о чем угодно, касающемся ваших данных. Задавайте вопросы о своих данных и мгновенно получайте ответы на основе ИИ. Изучайте, суммируйте, синтезируйте и извлекайте ценные данные из ваших файлов в 100 раз быстрее.
- [Chatbase | ChatGPT для вашего сайта](https://www.chatbase.co/) - Создавайте ИИ-чат-бота на основе своей базы знаний и добавляйте его на свой веб-сайт.

### 💻 <a id="instrumenty-dlya-razrabotchikov">Инструменты для разработчиков</a> 

- 👍 [Codeium · Бесплатное автодополнение кода и чат с ИИ](https://codeium.com/) - Codeium предлагает лучшее в своем классе автодополнение и поиск кода с помощью ИИ — и все это бесплатно. Он поддерживает более 70 языков и интегрируется с вашими любимыми IDE, обладая молниеносной скоростью и высочайшим качеством предлагаемых вариантов.
- [Cursor | Создавайте быстро](https://www.cursor.so/) - Редактор кода с приоритетом ИИ. Создавайте программы быстрее в редакторе, предназначенном для парного программирования с ИИ.
- [Bito AI - станьте разработчиком в 10 раз продуктивнее с Bito AI - Bito](https://bito.ai/)
- [Осмысленные тесты кода для занятых разработчиков | CodiumAI](https://www.codium.ai/) - С CodiumAI вы получаете предложения по нетривиальным тестам прямо в своей IDE, что позволяет вам писать код с умом, создавать больше ценности и сохранять уверенность при отправке кода.
...
[![Участники](https://contrib.rocks/image?repo=LiLittleCat/awesome-free-chatgpt)](https://github.com/LiLittleCat/awesome-free-chatgpt/graphs/contributors)
